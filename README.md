...
| `TELEMETRY_COST_ODOS_USD` | Optional | Override per-call Odos cost estimate (USD, non-negative finite) |
| `TELEMETRY_COST_GRAPH_USD` | Optional | Override per-call The Graph cost estimate (USD, non-negative finite) |
| `TELEMETRY_COST_WALLET_USD` | Optional | Override per-call wallet cost estimate (USD, non-negative finite) |
| `TELEMETRY_COST_PAPER_USD` | Optional | Override per-call paper trading cost estimate (USD, non-negative finite) |
| `TELEMETRY_COST_DEFAULT_USD` | Optional | Override per-call default cost estimate (USD, non-negative finite) |
